...
class Variation extends BaseCommand
{
    ...
    public function send()
    {
        ...
        preg_match('/MJ::JOB::variation::([0-9])::(.*)/', $this->customId, $matches);
        ...
        throw new MidjourneyException("Can't find the number of image you want to variate.");
    }
