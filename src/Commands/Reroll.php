...
class Reroll extends BaseCommand
{
    ...
    public function send()
    {
        ...
        preg_match('/MJ::JOB::reroll::([0-9])::(.*)/', $this->customId, $matches);
        ...
        throw new MidjourneyException("Can't find the number of image you want to reroll.");
    }
